...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    details: Schema.Attribute.Component<'independent.details-blog', false>;
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    details: Schema.Attribute.Component<
      'independent.details-destination',
      false
    >;
    hotels: Schema.Attribute.Integer;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    tag: Schema.Attribute.String;
    title: Schema.Attribute.String;
    tours: Schema.Attribute.Integer;
    transports: Schema.Attribute.Integer;
    type: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFoodFood extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date: Schema.Attribute.String;
    description: Schema.Attribute.JSON;
    details: Schema.Attribute.Component<'independent.details-food', false>;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date: Schema.Attribute.String;
    description: Schema.Attribute.JSON;
    details: Schema.Attribute.Component<'independent.details-hotel', false>;
    duration: Schema.Attribute.Integer;
    durationLabel: Schema.Attribute.String;
    facilities: Schema.Attribute.Relation<'oneToMany', 'api::feature.feature'>;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Testimonials_AboutUS';
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attractions: Schema.Attribute.Relation<'oneToMany', 'api::feature.feature'>;
    badge: Schema.Attribute.String;
    category: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    tag: Schema.Attribute.String;
    title: Schema.Attribute.String;
    tourType: Schema.Attribute.String;
    type: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
