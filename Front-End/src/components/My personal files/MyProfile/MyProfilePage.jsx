...
//(2) ==> import MyListDataLayOut == Ok
import MyListDataLayOut from "../../../layout/MyListData LayOut/MyListDataLayOut";

//(3) ==> import MyProfileSection == OK
import MyProfileSection from "./MyProfile Section/MyProfileSection";
...
export default function MyProfilePage() {
  ...
  const UlMyLinks = [
    ...
    {
      icon: (
        <FaRegUser className="text-[20px] text-white  group-hover:ml-2 duration-800" />
      ),
    ...
    {
      icon: (
        <RiDashboard3Line className="text-[20px] text-(--primary-color) group-hover:ml-2 duration-800" />
      ),
    ...
    {
      icon: (
        <IoAddCircleOutline className="text-[20px] text-(--primary-color) group-hover:text-(--primary-color) group-hover:ml-2 duration-800" />
      ),
  ...
  return (
    <section className={MyProfilePage_Styling.Styling1}>
      ...
      <HerSection
        NamePage={"My Profile"}
        src={"bg-[url('/Images/MyPersonal_Img_HerSection.jpg')]"}
        position={"center"}
        t={t}
      />
      {/* ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
