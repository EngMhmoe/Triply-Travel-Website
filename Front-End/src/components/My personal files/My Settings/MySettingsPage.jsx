...
import MySettingsSection from "./MySettings Section/MySettingsSection";
...
export default function MySettingsPage() {
  ...
  const UlMyLinks = [
    ...
    {
      icon: (
        <IoSettingsOutline className="text-[20px] text-white group-hover:ml-2 duration-800" />
      ),
