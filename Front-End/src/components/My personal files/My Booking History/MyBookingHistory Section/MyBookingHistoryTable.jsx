...
export default function MyBookingHistoryTable({
  visibleData,
  statusStyle,
  setViewItem,
  setCancelItem,
            ...
            <td className="py-4">
              <div className="flex justify-center items-center gap-2">
                ...
                <motion.button
                  ...
                  className="w-10 h-10 rounded-4xl border border-(--primary-color)  text-(--primary-color) font-bold text-lg duration-800 hover:bg-(--primary-color) cursor-pointer hover:text-white transition"
                >
