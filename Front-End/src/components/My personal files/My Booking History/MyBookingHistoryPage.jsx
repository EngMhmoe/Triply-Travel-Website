...
import MyBookingHistorySection from "./MyBookingHistory Section/MyBookingHistorySection";
...
export default function MyBookingHistoryPage() {
  ...
  const UlMyLinks = [
    ...
    {
      icon: (
        <FaHistory className="text-[20px] text-white group-hover:ml-2 duration-800" />
      ),
    ...
    <section className={MyProfilePage_Styling.Styling1}>
      ...
      <section className={MyProfilePage_Styling.Styling2}>
        <section className="flex sm:flex-row flex-col items-start gap-x-6 gap-y-15 max-w-7xl m-auto">
          ...
          {/* Component MyBookingHistorySection */}
          <section className="grow overflow-hidden w-full">
            <MyBookingHistorySection />
          </section>
        </section>
      </section>
    </section>
