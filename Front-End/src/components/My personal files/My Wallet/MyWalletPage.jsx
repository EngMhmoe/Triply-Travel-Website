...
import MyWalletSection from "./MyWallet Section/MyWalletSection";
...
export default function MyWalletPage() {
  ...
  const UlMyLinks = [
    ...
    {
      icon: (
        <BiWallet className="text-[20px] text-white group-hover:ml-2 duration-800" />
      ),
