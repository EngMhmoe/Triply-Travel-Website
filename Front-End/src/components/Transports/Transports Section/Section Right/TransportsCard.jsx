...
export default function TransportsCard({
  ...
  const CarSwiperSlidCard_Styling = {
    ...
    Styling17: "text-(--primary-pera) font-semibold",

    ////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////

    Styling18:
      "flex i\tems-center gap-1 text-(--primary-pera) font-bold  hover:text-(--primary-color2) duration-500 cursor-pointer hover:underline",

    ////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////

    Styling19:
      "grid grid-cols-2 gap-4 mt-4  font-semibold text-(--primary-pera)",
  ...
  return (
    <motion.div layout className="bg-white rounded-2xl shadow overflow-hidden">
      ...
      <div className={CarSwiperSlidCard_Styling.Styling6}>
        ...
        {/* Specs */}
        <div className={CarSwiperSlidCard_Styling.Styling19}>
          <section className={CarSwiperSlidCard_Styling.Styling20}>
            <FaCar className={CarSwiperSlidCard_Styling.Styling12} />
            {t("Model".toLowerCase())}: {Item.model}
          </section>
          ...
          <section className={CarSwiperSlidCard_Styling.Styling20}>
            <FaUserFriends className={CarSwiperSlidCard_Styling.Styling12} />
            {Item.seats} {t("People".toLowerCase())}
          </section>
          ...
          <section className={CarSwiperSlidCard_Styling.Styling20}>
            <FaGasPump className={CarSwiperSlidCard_Styling.Styling12} />
            {t(Item.fuel.toLowerCase())}
          </section>
          ...
          <section className={CarSwiperSlidCard_Styling.Styling20}>
            <FaCogs className={CarSwiperSlidCard_Styling.Styling12} />
            {t(Item.transmission.toLowerCase())}
          </section>
        </div>
